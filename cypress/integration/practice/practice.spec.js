describe('React TodoMVC practice', () => {
    ...
    const TODO_ITEM_FOUR = "Go to the gas station"
    const TODO_ITEM_FIVE = "Buy Bread"
  ...
  it('adds five todos', () => {
    ...
    cy.get(".new-todo").type(`${TODO_ITEM_FOUR}{enter}`)
    cy.get(".new-todo").type(`${TODO_ITEM_FIVE}{enter}`)
